...
// if we want to store something we need a memory space
...
accountBranch = "jaipur";  // javascipt is this much safe and secure language that we can reserved memory without giving a variable name but this method we should not use
...
// let, const and var are keyword whose syntax is written in compiler when we put these variable in compiler then complere have already have syntax of these keyword now it will do the its work
